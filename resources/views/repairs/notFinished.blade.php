    ...
    <div class="py-2">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <div> 
                    @if($role <= 1)
                    <span class="float-left py-2"><a href="/repairs/create" class="btn btn-success" data-toggle="modal" data-target="#createRepairModal">Pridėti naują</a></span>
                    @endif
                </div>
                @if(count($notFinishedRepairs))
                    <table class="table table-sm table-hover table-striped">
                        ...
                        @foreach($notFinishedRepairs as $repair)
                            <tr>
        ...
        <div class="modal-body">
            {!! Form::open(['action' => 'RepairsController@store', 'method' => 'POST']) !!}
                ...
                <div class="form-group">
                    ...
                    {!! Form::text('spec_komp',null, ['class' => 'form-control']) !!}
                </div>
                <div class="form-group">
                    {!! Form::label('Gedimai') !!}
                    {!! Form::text('gedimai',null, ['class' => 'form-control']) !!}
                </div>
                <div class="form-group">
                    {!! Form::label('Pastabos') !!}
                    {!! Form::text('pastabos',null, ['class' => 'form-control']) !!}
                </div>
